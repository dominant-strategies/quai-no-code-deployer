...
declare global {
	...
	type PlainTextShardName = 'Cyprus-1' | 'Cyprus-2' | 'Cyprus-3' | 'Paxos-1' | 'Paxos-2' | 'Paxos-3' | 'Hydra-1' | 'Hydra-2' | 'Hydra-3';
	type RPCShardName = 'cyprus1' | 'cyprus2' | 'cyprus3' | 'paxos1' | 'paxos2' | 'paxos3' | 'hydra1' | 'hydra2' | 'hydra3';
	type ShardNames = {
