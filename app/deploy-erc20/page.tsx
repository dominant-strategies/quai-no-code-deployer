  ...
  return (
    <BaseLayout heading="Token Deployer">
      <Flex direction="column" align="center" gap={20}>
        ...
        <Flex align="flex-start" direction="column" maxW={{ base: '90vw', md: '800px' }} gap={6}>
          <VStack align="flex-start">
            ...
            <Text variant="p2">
              ...
              requires more advanced features such as custom distribution, consider writing your own contract and
              deploying it via Hardhat.
            </Text>
          </VStack>
          <CodeBlock fileName="erc20.sol" language="solidity">
            {ERC20}
          </CodeBlock>
        </Flex>
      </Flex>
